...
public class ExplicitWaitDemo {
	...
	public static void main(String[] args) {
		...
		try {
		WebElement weblink =mywait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h3[text()='Selenium']")));
		weblink.click();
		}
		catch(Exception e)
		{
		...
		//driver.findElement(By.xpath("//h3[text()='Selenium']")).click();//not needed
